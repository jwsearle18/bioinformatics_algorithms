"""
This file contains functions to perform a local alignment of two strings.
"""
...
def create_matrix(match_reward: int, mismatch_penalty: int, indel_penalty: int, s: str, t: str) -> Tuple[List[Tuple], Tuple ,int, List[List[int]]]:
    """
    Creates the alignment matrix and back-tracking matrix for a local alignment.

    Args:
        match_reward: The reward for a match.
        mismatch_penalty: The penalty for a mismatch.
        indel_penalty: The penalty for an insertion or deletion.
        s: The first string.
        t: The second string.

    Returns:
        A tuple containing a list of possible end positions, the position of the maximum value in the matrix, the maximum
        value in the matrix, and the back-tracking matrix.
    """
    v = len(s)
    w = len(t)
    matrix = []
...
def local_alignment(match_reward: int, mismatch_penalty: int, indel_penalty: int, s: str, t: str) -> Tuple[int, str, str]:
    """
    Performs a local alignment of two strings.
    ...
    Returns:
        A tuple containing the maximum alignment score and the two aligned strings.
    """
