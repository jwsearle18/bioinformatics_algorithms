"""
This file contains functions to perform a global alignment of two strings.
"""
...
def create_matrix(match_reward: int, mismatch_penalty: int, indel_penalty: int, s: str, t: str) -> Tuple[int, List[List[int]]]:
    """
    Creates the alignment matrix and back-tracking matrix for a global alignment.
    ...
    Returns:
        A tuple containing the maximum alignment score and the back-tracking matrix.
    """
    v = len(s)
    w = len(t)
    matrix = []
...
def global_alignment(match_reward: int, mismatch_penalty: int, indel_penalty: int, s: str, t: str) -> Tuple[int, str, str]:
    """
    Performs a global alignment of two strings.
